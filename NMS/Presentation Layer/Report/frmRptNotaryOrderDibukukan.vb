Public Class frmRptNotaryOrderDibukukan
    ...
    Private Sub prvPreview()
        ...
        Dim crReportFile As New rptNotaryOrderDibukukan
        crReportFile.SetDataSource(DL.Report.NotaryOrder(dtpDateFrom.Value.Date, dtpDateTo.Value.Date, 2))
...
#Region "Form Handle"
    ...
    Private Sub frmRptSummaryLocalPurchaseByCategory_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        txtReportTitle.Text = "LAPORAN SURAT DI BAWAH TANGAN YANG DIBUKUKAN"
    End Sub
