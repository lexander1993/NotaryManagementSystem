Public Class frmRptOutstandingPayment
    ...
    Private Sub prvPreview()
        ...
        Dim crReportFile As New rptOutstandingPayment
        crReportFile.SetDataSource(DL.Report.OutstandingPayment(dtpDateFrom.Value.Date, dtpDateTo.Value.Date))
...
#Region "Form Handle"
    ...
    Private Sub frmRptSummaryLocalPurchaseByCategory_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        txtReportTitle.Text = "OUTSTANDING PAYMENT REPORT"
    End Sub
