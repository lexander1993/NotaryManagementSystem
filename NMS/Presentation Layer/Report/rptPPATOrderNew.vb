...
Public Class rptPPATOrderNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NMS.rptPPATOrderNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPPATOrderNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPPATOrderNew = New rptPPATOrderNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
