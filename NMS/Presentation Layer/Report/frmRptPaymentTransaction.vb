Public Class frmRptPaymentTransaction
    ...
    Private Sub prvPreview()
        ...
        Dim crReportFile As New rptPaymentTransaction
        crReportFile.SetDataSource(DL.Report.PaymentTransaction(dtpDateFrom.Value.Date, dtpDateTo.Value.Date))
...
#Region "Form Handle"
    ...
    Private Sub frmRptSummaryLocalPurchaseByCategory_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        txtReportTitle.Text = "PAYMENT TRANSACTION REPORT"
    End Sub
