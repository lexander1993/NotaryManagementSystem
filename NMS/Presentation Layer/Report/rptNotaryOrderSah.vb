...
Public Class rptNotaryOrderSah
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NMS.rptNotaryOrderSah.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotaryOrderSah
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotaryOrderSah = New rptNotaryOrderSah()
        rpt.Site = Me.Site
        Return rpt
    End Function
