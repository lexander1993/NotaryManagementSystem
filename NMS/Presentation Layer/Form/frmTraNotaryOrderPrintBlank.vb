...
Public Class frmTraNotaryOrderPrintBlank
...
#Region "Function"
    ...
    Private clsDataPII2 As New VO.NotaryClientDet2
    ...
    Private Sub prvFillForm()
        ...
        Try
            ...
            clsDataPII2 = DL.NotaryOrder.GetPihakII2(strNotaryOrderID)
            ...
            cboTitlePII2.Text = clsDataPII2.Title
            txtNamaPII2.Text = clsDataPII2.Nama
            txtTempatLahirPII2.Text = clsDataPII2.TempatLahir
            txtTanggalLahirPII2.Text = clsDataPII2.TglLahirStr
            txtWNPII2.Text = clsDataPII2.WargaNegara
            txtPekerjaanPII2.Text = clsDataPII2.Pekerjaan
            txtAlamatPII2.Text = clsDataPII2.Alamat
            txtJenisIDPII2.Text = clsDataPII2.JenisID
            txtNOIDPII2.Text = clsDataPII2.NoID

            cboTitlePenghadap.Text = clsDataPII.Title
            txtNamaPenghadap.Text = clsDataPII.Nama
    ...
    Private Sub prvPrint()
        ...
        oWord.Visible = True
        oDoc = oWord.Documents.Add(UI.usUserApp.BlankTemplateLocation)
        ...
        oDoc.Bookmarks.Item("TitlePII2").Range.Text = cboTitlePII2.Text
        oDoc.Bookmarks.Item("NamaPII2").Range.Text = txtNamaPII2.Text
        oDoc.Bookmarks.Item("TempatLahirPII2").Range.Text = txtTempatLahirPII2.Text
        oDoc.Bookmarks.Item("TanggalLahirPII2").Range.Text = txtTanggalLahirPII2.Text
        oDoc.Bookmarks.Item("WargaNegaraPII2").Range.Text = txtWNPII2.Text
        oDoc.Bookmarks.Item("PekerjaanPII2").Range.Text = txtPekerjaanPII2.Text
        'oDoc.Bookmarks.Item("AlamatPII2").Range.Text = txtAlamatPII2.Text
        oDoc.Bookmarks.Item("JenisIDPII2").Range.Text = txtJenisIDPII2.Text
        oDoc.Bookmarks.Item("NoIDPII2").Range.Text = txtNOIDPII2.Text
        'oDoc.Bookmarks.Item("KeteranganPII").Range.Text = txtKeteranganPII.Text

        oDoc.Bookmarks.Item("TitlePIIA").Range.Text = cboTitlePenghadap.Text ' cboTitlePII.Text
        oDoc.Bookmarks.Item("NamaPIIA").Range.Text = txtNamaPenghadap.Text   'txtNamaPII.Text
        ...
        If txtNamaPII2.Text = "" Then
            oWord.Selection.GoTo(What:=Word.WdGoToItem.wdGoToBookmark, Name:="NoIDPII2")
            With oWord.ActiveDocument.Bookmarks
                .DefaultSorting = Word.WdBookmarkSortBy.wdSortByName
                .ShowHidden = False
            End With
        ...
        If txtNamaPII.Text = "" Then
            oWord.Selection.GoTo(What:=Word.WdGoToItem.wdGoToBookmark, Name:="NoIDPII")
            With oWord.ActiveDocument.Bookmarks
                .DefaultSorting = Word.WdBookmarkSortBy.wdSortByName
                .ShowHidden = False
            End With
            oWord.Selection.MoveDown(Unit:=Word.WdUnits.wdLine, Count:=3)
            oWord.Selection.HomeKey(Unit:=Word.WdUnits.wdLine)
            oWord.Selection.MoveUp(Unit:=Word.WdUnits.wdLine, Count:=4, Extend:=Word.WdMovementType.wdExtend)
            oWord.Selection.Delete(Unit:=Word.WdUnits.wdCharacter, Count:=1)
        End If
    ...
    Private Sub btnSaksi1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaksi1.Click
        ...
        With frmDetail
            ...
            If .pubIsLookUpGet Then
                ...
                'dtpS1.Value = .pubLUDataRow("BirthDate")
    ...
    Private Sub btnSaksi2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSaksi2.Click
        ...
        With frmDetail
            ...
            If .pubIsLookUpGet Then
                ...
                'dtpS2.Value = .pubLUDataRow("BirthDate")
                txtTanggalLahirS2.Text = .pubLUDataRow("BirthDateStr")
                'txtTanggalLahirS2.Text = dtpS2.Value.ToString("dd-MM-yyyy") & " ( )"
