Namespace VO
    ...
    Public Class NotaryClientDet2

        Private strNotaryOrderID, strJenisID, strNoID, strWargaNegara, strNegara, strNama, strTempatLahir, strTglLahir, strTitle As String
